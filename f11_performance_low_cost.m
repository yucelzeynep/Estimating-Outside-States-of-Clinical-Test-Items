...
estimated_states = estimated_states_low_cost;
% reconstrict ground truhm matrices for low cost

all_test_states_gt = all_test_states(all_test_states_sliding(:,1)~=-1, find(is_estimated_low));
all_test_states_sliding_gt = all_test_states_sliding(all_test_states_sliding(:,1)~=-1, find(is_estimated_low));
